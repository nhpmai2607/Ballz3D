...
public class BallSetting : MonoBehaviour {
    ...
    void Start()
    {
        ...
        playerMatIndex = PlayerPrefs.HasKey("Ball") && playerMaterials.Contains(PlayerPrefs.GetInt("Ball"))
            ? playerMaterials.IndexOf(PlayerPrefs.GetInt("Ball")) : 0;
        setAction();
    }
    ...
    private void setAction()
    {
        ...
        checkButtonsState();
        PlayerPrefs.SetInt("Ball", playerMaterials[playerMatIndex]);
        PlayerPrefs.Save();
    }
